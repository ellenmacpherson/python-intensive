...
#Task 3: Create own list and print
...
#Task 4: Looping through string data type
...
#Task 5: Looping through tuple data type
...
#Task 6 & 7: Looping through dictionary data type
...
#Task 8: Combining counting loop and conditionals to filter out values
...
# Task 11 & 12: Loop with range function & Using breaks
...
# Task 14: Multiplication - creating a 10 x 10 mulitplication table

#----------------------------------------------------------------------------------


for i in range(1,11): #columns
   for j in range(1,11): #rows
      print('{0:>3}'.format(i * j), end=' ') #{0:>3} is a placeholder
   print('\n') 
